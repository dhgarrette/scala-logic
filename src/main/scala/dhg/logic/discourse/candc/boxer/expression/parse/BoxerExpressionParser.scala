package dhg.logic.discourse.candc.boxer.expression.parse

import dhg.logic.util.Counter
import dhg.logic.top.expression.parse._
import dhg.logic.top.expression.parse.UnexpectedTokenException
 ...
 */
class BoxerExpressionParser(discourseId: String = "0") extends LogicParser[BoxerExpression](List(('\'', '\'', '\\', false))) {
